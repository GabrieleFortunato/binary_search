...
int main(void) {
	...
	CU_pSuite pSuite_D = CU_add_suite("SUITE BINARY SEARCH",init_suite_default,clear_suite_default);
	CU_add_test(pSuite_D,"test of binary_search()",test_binary_search);
